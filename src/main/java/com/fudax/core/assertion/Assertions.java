package com.fudax.core.assertion;
...
import com.fudax.logging.webdriver.LogMapKey;

/**
 * @author 测试仔刘毅
 */
public class Assertions {
	private final ReadConfiguration config = new ReadConfiguration("/com/fudax/core/webdriver/webdriver.properties");

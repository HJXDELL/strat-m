...
import com.fudax.report.ReportMetadata;
import com.fudax.report.ReportNGException;
import com.fudax.report.ReportNGUtils;
...
public abstract class AbstractReporter implements IReporter {
	...
	private static final ResourceBundle MESSAGES = ResourceBundle.getBundle("com.fudax.report.messages.report",
			META.getLocale());
